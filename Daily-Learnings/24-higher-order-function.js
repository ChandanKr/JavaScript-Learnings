...
//?   A "first-class function" means that functions can be treated as values, assigned to variables, and passed around as arguments.
    ...
    console.log(greetFunction("Chandan"));
...
//* Here is the example ✅
    ...
    processUserInput("Chandan", greetUser);

    //todo:  processUserInput is a higher-order function because it takes another function (callback) as an argument.

    //todo:  greetUser is a callback function because it's passed as an argument to processUserInput and gets executed after the completion of the main task
