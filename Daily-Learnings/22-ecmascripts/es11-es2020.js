...
//* =========================================
    ...
    //? List of new useful features added in ES11  👇
        // BigInt
...
//? BigInt: BigInt in JavaScript is a data type used to represent and perform operations on large integers that exceed the limits of regular numbers.
    ...
    // Using the BigInt() constructor:
        ...
        // console.log(num); // 9007199254741001n
...
//? It provides a concise way to access properties of an object without worrying about the existence of intermediate properties. It's particularly useful when working with nested objects or accessing properties of objects that may be null or undefined.
    ...
    // const city = person.address.city; // This is traditional way
    ...
    const city = person.address?.city ?? "city is not present"; // Output: Delhi/city is not present
    console.log(city);

    // This is same as ternary operator, but here we can't handle if city is not there in object
    // const city = person.address ? person.address.city : "city is not present"; // Output: Delhi/undefined
